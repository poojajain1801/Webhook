...
public class DeviceDetailServiceImplTest {
    ...
    private DeviceInfo devieceDetail = new DeviceInfo("352099001761481", "user001", "123456789",
            "ANDROID", "4.4", "2F6D63", "PHONE", "CLOUD",
            "YES", "352099001761481", "8861329101", "MYPHONE");

    private RegDeviceParam regDeviceParam = new RegDeviceParam("tanmaya",
            "40",
            "4BE25E93B9CDE42CC6DD5EA826456812",
            "WalletApp1",
            "123456789",
            "4c4ead5927f0df8117f178eea9308daa58e27c2b",
            "",
    ...
    public void registerDeviece() throws Exception {
        DeviceRegistrationResponse response = deviceDetailService.registerDevice(regDeviceParam);
