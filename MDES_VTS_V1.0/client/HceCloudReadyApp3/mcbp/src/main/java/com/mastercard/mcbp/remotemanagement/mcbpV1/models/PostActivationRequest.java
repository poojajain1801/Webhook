...
public class PostActivationRequest {
     ...
     * @return PostActivationRequest object.
     */
    public static PostActivationRequest valueOf(final String jsonString) {
        return new JSONDeserializer<PostActivationRequest>().deserialize(jsonString,
                PostActivationRequest.class);
    }
