...
/**
 * This exception is raised if the information query for a certain user fails
 */
public class UserInformationNotFound extends LdeCheckedException {
     ...
     * */
    public UserInformationNotFound(String reason) {
        super(reason, ErrorCode.NO_USER_INFORMATION_FOUND);
    }
}
