...
public class DsrpResult {
    ...
    /**
     * Get remote payment Transaction Result Code
     */
    private final RemotePaymentResultCode code;

    public DsrpResult(RemotePaymentResultCode code, DsrpOutputData data) {
        this.data = data;
        this.code = code;
    }
