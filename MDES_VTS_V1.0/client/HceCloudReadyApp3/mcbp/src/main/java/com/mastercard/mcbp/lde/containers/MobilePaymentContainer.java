...
/**
 * Contains the attributes for registered Digitized Cards which are mainly used by MPPLite in
 * order to be able to make payment transactions.
 */
...
public class MobilePaymentContainer {
    ...
    public MppLiteModule getMppLiteModule() {
        return mMppLiteModule;
    }

    public void wipeData() {
        if(mMppLiteModule != null){
            mMppLiteModule.wipe();
        }
    }
}
