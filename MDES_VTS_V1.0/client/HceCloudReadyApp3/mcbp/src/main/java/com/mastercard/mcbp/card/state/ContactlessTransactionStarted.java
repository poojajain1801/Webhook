...
/**
 * In this state the MCBP Card is ready to start a contactless transaction, but it has not received
 * any APDU yet
 */
class ContactlessTransactionStarted extends GenericState {
    /***
     * Default constructor for the state. The context must be provided
     * @param cardContext The MCBP Card State context
     */
    public ContactlessTransactionStarted(final CardContext cardContext,
