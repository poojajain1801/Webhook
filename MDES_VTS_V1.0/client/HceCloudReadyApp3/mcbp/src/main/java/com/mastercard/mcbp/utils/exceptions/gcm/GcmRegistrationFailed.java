...
public class GcmRegistrationFailed extends McbpCheckedException {
     ...
     */
    public GcmRegistrationFailed(String reason) {
        super(reason, ErrorCode.GCM_REGISTRATION_FAILED);
    }
     ...
     */
    public GcmRegistrationFailed(String reason, final ErrorCode errorCode) {
        super(reason, (errorCode != null ? errorCode : ErrorCode.GCM_REGISTRATION_FAILED));
    }
}
