...
/**
 * A custom X509TrustManager implementation that trusts a specified server certificate.
 */
public class CustomTrustManager implements X509TrustManager {
    ...
    public void checkServerTrusted(X509Certificate[] chain, String authType)
        ...
        try {
            ...
            mLogger.d(Log.getStackTraceString(originalException));
            try {
                ...
                mLogger.d(Log.getStackTraceString(ex));
