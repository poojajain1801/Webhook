...
public class AESUtil {
    public static byte[] mobSessionKeyConf = ArrayUtil.getByteArray("E3D1952FCF798B3D64DA057A9587A5D0");
    public static byte[] mobSessionKeyMac = ArrayUtil.getByteArray("494E0E6A4E104386B59E950A3D3B719E");
    public static String tokenUniqueReference = "DWSPMC000000000132d72d4fcb2f4136a0532d3093ff1a45";
...
/*    public static void main(String[] args) {
       // getEncrawTransctionalData();
        int m2c =10;
        int c2m = 0;
        prepareEncReq(m2c, com.mahindracomviva.utils.aes.Constants.setorchangePinReq);
        encryptData();
        *//*prepareReplishmentReruest(m2c);
       ...
       *//**//* encTokenCredentials();*//**//*
        ...
        byte [] data = ArrayUtil.getByteArray("74DEB2B2BA1082AF2CD731D09A9BE97A");
        try {
            String key = ArrayUtil.getHexString(cipherECB(data, KEK_KEY, Padding.NoPadding, false));
            System.out.println("encdata="+key);
        } catch (GeneralSecurityException e) {
            e.printStackTrace();
        }*//*
        //encProvisionMPAReq(1);
       // encNotifyProvisionResultCmsReq(3);
   ...
   public String encryptData(String strData,String key)
    {
        String encData="";

        byte [] mobilDataeEncKey = ArrayUtil.getByteArray(key);
        byte [] data = ArrayUtil.getByteArray(strData);
        try {
             encData = ArrayUtil.getHexString(cipherECB(data, mobilDataeEncKey, Padding.NoPadding, true));
    ...
    public static String prepareEncReq(int m2c,JSONObject jsonInput,String mobileSessionKeyConf,String mobileSessionKeyMac)
    {

        //JSONObject jsonInput = new JSONObject(input);
       // jsonInput.put("tokenUniqueReference",tokenUniqueReference);
       // String strInput =  jsonInput.toString();
        byte [] inputdata = new byte[0];
        inputdata = jsonInput.toString().getBytes();
       /* try {

        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }*/
        setMobSessionKeys(mobileSessionKeyConf,mobileSessionKeyMac);
        byte[] svM2c = prepareSv(m2c, true);
        String encData = "";
        byte []bEncData = new byte[0];
        String mac = "";
        try {
            bEncData = cipherCcm(inputdata,mobSessionKeyConf,svM2c,true);
            mac  = ArrayUtil.getHexString(aesMac(bEncData, mobSessionKeyMac));
    ...
    public static String getEncrawTransctionalData()
    {
        String input = "{\n" +
                "  \"rawTransactionCredentialsData\": {\n" +
                "    \"rawTransactionCredential\": [\n" +
                "      {\n" +
                "        \"atc\": 5,\n" +
                "        \"idn\": \"941AB4507CBA32EF5725EE3A5FBDF7C7\",\n" +
                "        \"contactlessMdSessionKey\": \"65F9A2EB817217607CE1AB036406BA05\",\n" +
                "        \"contactlessUmdSessionKey\": \"8C3816B781449506C0043FE513A010D1\",\n" +
                "        \"dsrpMdSessionKey\": \"A2FAB305BFEEFB93095E63822B5FD902\",\n" +
                "        \"dsrpUmdSessionKey\": \"74DEB2B2BA1082AF2CD731D09A9BE97A\"\n" +
                "      },\n" +
                "      {\n" +
                "        \"atc\": 6,\n" +
                "        \"idn\": \"941AB4507CBA32EF5725EE3A5FBDF7C7\",\n" +
       ...
       /* try {
        ...
        byte[] nonce = ArrayUtil.getByteArray("0102030405060708090A0B0C0D0E0F10");
        ...
        try {
            ...
            bEncData = cipherCcm(inputdata,AES_KEY,nonce,true);
            mac  = ArrayUtil.getHexString(aesMac(bEncData, AES_KEY));
            encData = ArrayUtil.getHexString(bEncData);
            encData = encData;
        } catch (GeneralSecurityException e) {
            e.printStackTrace();
    ...
    public static String encNotifyProvisionResultCmsReq(int m2c,String tokenUniqueReference,String mobileSessionKeyConf,String mobileSessionKeyMac) {
        ...
        try {
           ...
           // System.out.print("notifyProvisioningResultResponse = "+ArrayUtil.getHexString(encData));
    ...
    public  String encProvisionMPAReq(int m2c,String tokenUniqueReference,String mobileSessionKeyConf,String mobileSessionKeyMac) {
        ...
        try {
            ...
            System.out.println("encProvisonResponse = "+encryptedData);
    ...
    public static String encTokenCredentials() {
        ...
        byte[] key = ArrayUtil.getByteArray("4245BB09534AAE4DA6C5D52E5A074100");
        byte[] nonce = ArrayUtil.getByteArray("0102030405060708090A0B0C0D0E0F10");
        String encCardProfile ="";
        System.out.println(data);
        try {
            byte[] encData = AESUtil.cipherCcm(bData, key, nonce, true);
            encCardProfile= ArrayUtil.getHexString(encData);
