...
public class MppLiteModule {
    ...
    public void setCardRiskManagementData(final CardRiskManagementData cardRiskManagementData) {
    ...
    public void setContactlessPaymentData(final ContactlessPaymentData contactlessPaymentData) {
    ...
    public void setRemotePaymentData(final RemotePaymentData remotePaymentData) {
