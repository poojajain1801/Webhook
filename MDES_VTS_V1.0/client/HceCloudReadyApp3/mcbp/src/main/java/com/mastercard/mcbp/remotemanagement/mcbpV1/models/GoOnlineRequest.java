...
public class GoOnlineRequest {
    ...
    /**
     * Returns equivalent {@link com.mastercard.mcbp.remotemanagement.mcbpV1.models.GoOnlineRequest}
     * object from given json string.
     *
     * @param jsonString Json string.
     * @return GoOnlineRequest object.
     */
    public static GoOnlineRequest valueOf(final String jsonString) {
        return new JSONDeserializer<GoOnlineRequest>().deserialize(jsonString,
