...
/**
 * This Exception is raised when the a Digitized Card is not found in the Lde
 */
public class CardNotFound extends LdeCheckedException {
     ...
     * */
    public CardNotFound(String reason) {
        super(reason, ErrorCode.DIGITIZED_CARD_ID_NOT_FOUND);
    }
}
