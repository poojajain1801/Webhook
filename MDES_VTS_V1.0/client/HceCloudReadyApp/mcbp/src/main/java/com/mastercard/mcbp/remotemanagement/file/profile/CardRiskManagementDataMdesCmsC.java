...
class CardRiskManagementDataMdesCmsC {
    ...
    public CardRiskManagementDataMdesCmsC(){
    }
    ...
    public void setAdditionalCheckTable(String additionalCheckTable) {
        this.additionalCheckTable = additionalCheckTable;
    }
    ...
    public void setCrmCountryCode(String crmCountryCode) {
        this.crmCountryCode = crmCountryCode;
    }
