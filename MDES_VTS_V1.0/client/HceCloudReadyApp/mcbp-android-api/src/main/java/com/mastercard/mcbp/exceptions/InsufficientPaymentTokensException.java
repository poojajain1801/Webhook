...
/**
 * Exception for when attempting to make a payment with a card that doesn't have any payment
 * tokens remaining.
 */
public class InsufficientPaymentTokensException extends McbpCardException {
    /**
     * Constructor.
     */
