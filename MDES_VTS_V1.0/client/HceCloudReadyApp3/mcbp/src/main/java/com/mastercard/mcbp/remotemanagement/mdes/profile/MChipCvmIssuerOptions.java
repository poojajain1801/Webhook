...
public class MChipCvmIssuerOptions {
    ...
    public void setAckAlwaysRequiredIfCurrencyProvided(final boolean ackAlwaysRequiredIfCurrencyProvided) {
    ...
    public void setAckAutomaticallyResetByApplication(final boolean ackAutomaticallyResetByApplication) {
    ...
    public void setPinAlwaysRequiredIfCurrencyNotProvided(final boolean pinAlwaysRequiredIfCurrencyNotProvided) {
    ...
    public void setPinAlwaysRequiredIfCurrencyProvided(final boolean pinAlwaysRequiredIfCurrencyProvided) {
    ...
    public void setPinAutomaticallyResetByApplication(final boolean pinAutomaticallyResetByApplication) {
