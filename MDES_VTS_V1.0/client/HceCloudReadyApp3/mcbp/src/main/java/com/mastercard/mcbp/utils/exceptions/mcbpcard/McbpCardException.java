 ...
 */
public class McbpCardException extends McbpUncheckedException {
    /**
     * Constructor. A reason must be provided
     * @param reason A string describing the reason for the exception
     * */
    public McbpCardException(String reason) {
     ...
     * */
    public McbpCardException(String reason, final ErrorCode errorCode) {
