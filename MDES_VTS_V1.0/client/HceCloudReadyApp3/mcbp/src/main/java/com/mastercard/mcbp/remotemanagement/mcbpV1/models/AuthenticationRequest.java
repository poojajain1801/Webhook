...
public class AuthenticationRequest {
    ...
    /**
     * Returns equivalent {@link AuthenticationRequest}
     * object from given json string.
     *
     * @param jsonString Json string.
     * @return AuthenticationRequest object.
     */
    public static AuthenticationRequest valueOf(final String jsonString) {
        return new JSONDeserializer<AuthenticationRequest>().deserialize(jsonString,
