...
/**
 * This Exception is typically raised when a Command APDU contains a wrong INS value or not
 * supported
 */
public class InvalidIns extends InvalidCommandApdu {
     ...
     */
    public InvalidIns(String reason) {
        super(reason, Utils.byteToChar(ResponseApduFactory.instructionCodeNotSupported()));
    }
}
