...
class CommonMcbpCardApi {
     ...
     * @since 1.0.2
     */
    public static boolean isDefaultCardForContactlessPayment(String digitizedCardId) {
     ...
     * @since 1.0.2
     */
    public static boolean isDefaultCardForRemotePayment(String digitizedCardId) {
        McbpCard defaultRemoteCard = McbpWalletApi.getDefaultCardForRemotePayment();
        return defaultRemoteCard != null && defaultRemoteCard.getDigitizedCardId()
                                                             .equalsIgnoreCase(digitizedCardId);
    }
     ...
     * @since 1.0.2
     */
    public static boolean remoteWipeSuksForCardWithId(String digitizedCardId) {
        try {
    ...
    public static boolean remoteWipeCardWithId(String digitizedCardId) {
        try {
            McbpInitializer.getInstance()
                           .getLdeRemoteManagementService()
     ...
     */
    @SuppressWarnings("WeakerAccess")
    public static boolean wipeCard(String digitizedCardId) {
        try {
     ...
     * @since 1.0.2
     */
    public static List<TransactionLog> getTransactionLogsForCardWithId(String digitizedCardId) {
     ...
     * @since 1.0.2
     */
    private static void enforceKeyManagementPolicy(McbpCard card) throws AlreadyInProcessException {
        ...
        if (keyManagementPolicy.shouldRequestNewKeys(card)) {
            ...
            try {
                if (McbpInitializer.getInstance().getKeyAcquirer().acquireKeysForCard(card)) {
                    ArrayList<WalletEventListener> walletEventListeners =
                            McbpApi.getWalletEventListeners();
                    for (WalletEventListener listener : walletEventListeners) {
                        if (listener.paymentTokensAdded(card.getDigitizedCardId())) {
                            break;
                        }
                    }
                }
