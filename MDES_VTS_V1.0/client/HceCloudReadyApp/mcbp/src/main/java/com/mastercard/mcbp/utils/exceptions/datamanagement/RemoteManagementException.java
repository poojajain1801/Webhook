...
/**
 * Base class for all the exceptions related to Remote Management operations with the Credential
 * Management System
 */
public class RemoteManagementException extends McbpCheckedException {
     ...
     * */
    public RemoteManagementException(String reason) {
        super(reason, ErrorCode.REMOTE_MANAGEMENT_ERROR);
    }
     ...
     * */
    public RemoteManagementException(String reason, final ErrorCode errorCode) {
        super(reason, (errorCode != null ? errorCode: ErrorCode.REMOTE_MANAGEMENT_ERROR));
    }
}
