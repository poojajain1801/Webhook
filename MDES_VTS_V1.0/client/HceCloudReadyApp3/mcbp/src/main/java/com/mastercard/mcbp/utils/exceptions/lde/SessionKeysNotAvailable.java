 ...
 */
public class SessionKeysNotAvailable extends LdeCheckedException {
    /**
     * Constructor.  A reason must be provided
     * @param reason A string describing the reason for the exception
     * */
    public SessionKeysNotAvailable(String reason) {
        super(reason, ErrorCode.NO_SESSION_KEYS_AVAILABLE);
    }
}
