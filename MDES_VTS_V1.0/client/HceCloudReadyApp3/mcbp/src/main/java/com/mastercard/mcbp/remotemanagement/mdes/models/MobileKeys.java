...
public class MobileKeys {
    ...
    /**
     * Returns equivalent
     * {@link com.mastercard.mcbp.remotemanagement.mdes.models.MobileKeys}
     * object from given json string.
     *
     * @param jsonContent Json content to be convert in to MobileKeys object.
     * @return MobileKeys object.
     */
    public static MobileKeys valueOf(String jsonContent) {
        return new JSONDeserializer<MobileKeys>().deserialize(jsonContent,
                                                              MobileKeys.class);
    }
    ...
    public String toString() {
        ...
        if (BuildInfo.isDebugEnabled()) {
            return "MobileKeys [transportKey=" + transportKey + ", macKey="
                   + macKey + ", dataEncryptionKey=" + dataEncryptionKey + "]";
        } else {
            return "MobileKeys";
        }
    }
