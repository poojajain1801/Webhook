...
/**
 *  \brief     Card Record Log
 *  \details   This object contains the transaction record log of the last
 *             contactless transaction including application cryptogram and
...
struct CardRecord {
 public:
  ...
  ByteArray issuer_application_data;  /*  8 bytes     */
...
#endif  // defined(SRC_CORE_MCM_CARD_RECORD_H_)  // NOLINT
