...
/**
 * This exception is thrown if a remote management message is unexpected (e.g. a request with an
 * old session id, etc)
 */
public class UnexpectedProtocolMessage extends RemoteManagementException {
     ...
     * */
    UnexpectedProtocolMessage(String reason) {
        super(reason, ErrorCode.UNEXPECTED_PROTOCOL_MESSAGE);
    }
}