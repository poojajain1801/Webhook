...
/**
 * Exception for when attempting to make a CMS-D request when earlier request is already in process.
 */
public class AlreadyInProcessException extends RemoteManagementException {
     ...
     */
    public AlreadyInProcessException(String reason) {
        super(reason, ErrorCode.ALREADY_IN_PROCESS);
    }
}
