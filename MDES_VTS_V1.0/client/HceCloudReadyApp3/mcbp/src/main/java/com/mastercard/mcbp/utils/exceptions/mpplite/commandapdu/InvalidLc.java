...
/**
 * This Exception is typically raised when a Command APDU contains a wrong LC value
 */
public class InvalidLc extends InvalidCommandApdu {
    /**
     * Constructor.
     *
     * @param reason A string describing the reason for the exception
     */
    public InvalidLc(String reason) {
        super(reason, Utils.byteToChar(ResponseApduFactory.wrongDataLength()));
    }
}