...
/**
 * This exception is thrown if the received Single Use Key is malformed or not valid
 */
public class InvalidSingleUseKey extends InvalidInput {
     ...
     * */
    public InvalidSingleUseKey(String reason) {
        super(reason, ErrorCode.INVALID_DIGITIZED_CARD_SINGLE_USE_KEY);
    }
}