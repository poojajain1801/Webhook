...
/**
 * This Exception is typically raised when a the SW conditions for execution are not met
 */
public class ConditionsOfUseNotSatisfied extends InvalidCommandApdu {
     ...
     */
    public ConditionsOfUseNotSatisfied(String reason) {
        super(reason, Utils.byteToChar(ResponseApduFactory.conditionsOfUseNotSatisfied()));
    }
}