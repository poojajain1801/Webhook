 ...
 */
public class LdeCheckedException extends McbpCheckedException {
    /**
     * Constructor.  A reason must be provided
     * @param reason A string describing the reason for the exception
     * */
    public LdeCheckedException(String reason) {
     ...
     * */
    public LdeCheckedException(String reason, final ErrorCode errorCode) {
